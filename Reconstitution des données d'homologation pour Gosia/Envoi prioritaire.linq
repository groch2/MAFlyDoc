...
var recipient = context.Set<Recipient>().First(r => r.RecipientId == 2017);
var sender = context.Set<Sender>().First(s => s.SenderId == 1247);
const string transportId = "1115256652259090862";
var envoi = new Envoi
{
    TransportId = long.Parse(transportId),
    Sender = sender,
    Recipient = recipient,
    MainDocumentGedId = "20231107224452023632540186",
    MailPostageId = MailPostage.ENVOI_PRIORITAIRE,
    NbRetriesLeft = 0,
};
